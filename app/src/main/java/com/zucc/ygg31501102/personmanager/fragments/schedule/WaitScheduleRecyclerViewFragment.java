...
public class WaitScheduleRecyclerViewFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new RecyclerViewAdapter.OnItemClickListener() {
            ...
            @Override
            public void onLongClick(final int position) { AlertDialog.Builder dialog = new AlertDialog.Builder(getActivity());
                dialog.setTitle("提醒");
                ...
                scheduleRemoveFromDatebase("" + id[0]);
                if (id[1] > 0) {
                    if (mIntent == null)
    ...
    public void initSchedule() {
        this.list = ScheduleFragment.WaitSchedule;
    }
